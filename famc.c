...
void proc_left_paren(struct parser *p) { p->sp = 0; }
void proc_right_paren(struct parser *p) { p->sp = 0; }
void proc_left_brace(struct parser *p) { p->sp = 0; }
void proc_right_brace(struct parser *p) { p->sp = 0; }
